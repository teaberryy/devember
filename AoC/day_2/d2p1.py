...
# First off, since I'm lazy, let's put every number into one big variable, then
# split the variable by rows
...
# Yeesh, did they really have to make it this big?
...
for rows in assigned_rows:
    ...
    checksum += (max(current_ints) - min(current_ints))
    row += 1
